...
#define PRESS_KEY "Нажмите любую клавишу для выхода..."s
...
#define SAVE_OK "Настройки всех сканеров были успешно сохранены в json-файлы"s
#define SAVE_FAIL "Сохранены настройки не со всех сканеров!"s
